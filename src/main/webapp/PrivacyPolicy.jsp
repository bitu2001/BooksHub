...
<body>
	...
	<p>Crispy Fhres built the Drag Racing Lights app as a Commercial
		app. This SERVICE is provided by Crispy Fhres and is intended for use
		as is.</p>
	<p>This page is used to inform visitors regarding my policies with
		the collection, use, and disclosure of Personal Information if anyone
		decided to use my Service.</p>
	<p>If you choose to use my Service, then you agree to the
	...
	<p>The terms used in this Privacy Policy have the same meanings as
		in our Terms and Conditions, which is accessible at Drag Racing Lights
	...
	<p>For a better experience, while using our Service, I may require
		...
		not collected by me in any way.</p>
	...
	<p>These Services do not address anyone under the age of 13. I do
		...
		me so that I will be able to do necessary actions.</p>
	<p>
	...
	<p>If you have any questions or suggestions about my Privacy
		Policy, do not hesitate to contact me.</p>
	<p>
		This privacy policy page was created at <a
			href="https://privacypolicytemplate.net" target="_blank">privacypolicytemplate.net</a>
		and modified/generated by <a
			href="https://app-privacy-policy-generator.firebaseapp.com/"
			target="_blank">App Privacy Policy Generator</a>
	</p>
